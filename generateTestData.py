...
def generateTestData(windowLength,q,N,SNRdB, audioFolder, noiseFile, filePathSave, save): 
    ...
    # Arguments
        ...
        filePathSave: file path where audio files are stored
        save: boolearn variable indicating whether to save files
    ...
    if save == 1:
        ...
        filePathSaveClean = filePathSave / "speech.wav"
        filePathSaveNoise = filePathSave / "noise.wav"
        filePathSaveMixed = filePathSave / "mixed.wav"
